...
from ...views.client.misc import user_profile, guides, guide_detail, printer_select, printer_track, mihi_activate
...
__all__ = [
    ...
    "user_profile", "guides", "guide_detail", "printer_select", "printer_track", "mihi_activate",
