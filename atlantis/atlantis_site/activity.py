"""Inactivity detection over a compiled timelapse video.
...
Units: the sample rate is one frame per video second, and both recorders stitch
one recorded minute into one second of video, so one segment second is one tracked
