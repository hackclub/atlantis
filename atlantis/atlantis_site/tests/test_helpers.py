...
class SsrfGuardTests(TestCase):
	...
	@patch("atlantis_site.views.helpers.socket.getaddrinfo")
...
class ContentTypeValidatorTests(TestCase):
	@patch("atlantis_site.views.helpers._safe_head")
...
class SlackDmTests(TestCase):
	@patch("atlantis_site.views.helpers.slack_client.chat_postMessage")
