...
class LoginViewTests(TestCase):
	...
	@patch("layered_site.views.client.auth.oauth.hackclub.authorize_redirect")
...
@patch("layered_site.views.client.auth.slack_client.users_info")
@patch("layered_site.views.client.auth.oauth.hackclub.authorize_access_token")
